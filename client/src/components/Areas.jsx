...
import carouselTwo from '../assets/car-image-two.jpg'; // Adjust the path as necessary
import carouselThree from '../assets/carousel-image.jpg'; // Adjust the path as necessary
...
const Areas = () => {
    ...
    return (
        <div>
            <div className='areas-header'> Nam vel porta roin egestas leo magna<br/>
             vel tincidunt magna laoreet eu.</div>
